...
app.get("/showUser", function (req, res) { // ROTA DA PAGINA INICIAL QUE LISTA AS PERGUNTAS FEITAS
  person
    .findAll({ // TODOS DADOS QUE ESTA NA BASE DADOS PERGUNTA
      raw: true,
      order: [
    ...
    .then((peoples) => {//PEGA CADA PERGUNTA E RENDERIZAR NO INDEX.EJS(FRONT DA PAGINA INICIAL)
      res.render("showUser", {
